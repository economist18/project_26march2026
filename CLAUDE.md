...
MixtapeTools — a collection of Claude Code skills, personas, and presentation tools for research workflows.
...
|------|----------|-----------|
| 2026-03-26 | Project scaffolded with /newproject | Standard structure for consistency |
...
Project scaffolded with standard directory structure.
